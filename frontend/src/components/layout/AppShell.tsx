...
import { LogOut, LayoutDashboard, FileText, FileClock, FileMinus, Package, Repeat, Users, BarChart3, Settings } from 'lucide-react';
...
export function AppShell() {
  ...
  const navItems = [
    ...
    { to: '/credit-notes', label: t('nav.creditNotes'), icon: FileMinus },
